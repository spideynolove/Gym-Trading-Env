...
extensions = ['sphinx.ext.githubpages', 'sphinx.ext.autodoc',
    'sphinx.ext.intersphinx', 'sphinx_copybutton', 'sphinxext.opengraph']
templates_path = ['_templates']
html_theme = 'furo'
html_title = 'Gym Trading Environment'
html_static_path = ['_static']
html_favicon = 'images/favicon.png'
html_theme_options = {'light_logo': 'logo_light-bg.png', 'dark_logo':
    'logo_dark-bg.png', 'sidebar_hide_name': True}
html_css_files = ['style.css']
ogp_site_url = 'https://gym-trading-env.readthedocs.io/'
ogp_image = (
    'https://gym-trading-env.readthedocs.io/en/latest/_images/render.gif')
